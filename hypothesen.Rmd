...
#Mixed effects model:
model1 <- lmer(value ~ name + (1|id),  data = analyse)
...
tab_model(model1, string.intercept = "(Interzept)", string.pred = "Prädiktoren", string.est = "Koeffizient", title = "Zusammenfassung des Mixed Effects Models", pred.labels = c("Interzept", "Stimuli (neutral)", string.ci= "Konf.Int(95%)", string.p = "P-Wert", p.style = "a"))
...
analyse <- transform(analyse, behavior_group=cut(analyse$behavior_items, breaks=c(-Inf, median(analyse$behavior_items), Inf), labels=c("low", "high")))
...
#Mixed effects model:
model2 <- lmer(value ~ behavior_group + (1|id),  data = analyse)
summary(model2)

tab_model(model2, string.intercept = "(Interzept)", string.pred = "Prädiktoren", string.est = "Koeffizient", title = "Zusammenfassung des Mixed Effects Models", pred.labels = c("Interzept", "Hohes nachhaltiges Verhalten", string.ci= "Konf.Int(95%)", string.p = "P-Wert", p.style = "a"))
...
#Mixed effects model:
model3 <- lmer(value ~ utopia_group + (1|id),  data = analyse)
summary(model3)
